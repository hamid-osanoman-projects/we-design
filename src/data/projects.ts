...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Modern office space design with custom workstations, meeting rooms, and premium joinery. Features include open-plan workspaces, executive offices, conference rooms, and a welcoming reception area with contemporary finishes.",
  ...
  },
  {
    ...
    location: "Barka, Oman",
    description: "Custom kitchen cabinetry and bedroom wardrobes with precision joinery and premium finishes. The kitchen features soft-close drawers, integrated appliances, and a large island. Master bedroom includes walk-in wardrobe with custom lighting.",
  ...
  },
  {
    ...
    location: "Barka, Oman",
    description: "Complete kitchen remodeling with custom cabinetry manufactured in our factory. Features include quartz countertops, integrated appliances, breakfast bar, and premium hardware. Modern clean-line design with maximum storage.",
  ...
  },
  {
    ...
    location: "Barka, Oman",
    description: "Multiple custom wardrobe installations featuring manufactured components with soft-close mechanisms, LED lighting, glass doors, and premium finishes. Maximizes storage with intelligent organization systems.",
  ...
  },
  {
    ...
    location: "Muscat, Oman",
    description: "Bespoke home library with floor-to-ceiling custom shelving, reading nook, rolling ladder, and integrated lighting. Manufactured components ensure precision fit and premium finish throughout.",
